...
| Phase 1 | Core Data Structures                | 0 / 6   | 🔲 Not Started |
...
| 5   | Prefix Sums                    | 🔲 Not Started | Precompute running totals for O(1) range queries |
| 6   | Sorting & Binary Search        | 🔲 Not Started | Know sort cost · binary search on sorted arrays  |
...
| 9   | Group Anagrams                            | 🟡 Medium  | Hash Map          | 🔲     |
| 10  | Product of Array Except Self              | 🟡 Medium  | Prefix Sums       | 🔲     |
| 11  | Top K Frequent Elements                   | 🟡 Medium  | Map + Sort        | 🔲     |
| 12  | 3Sum                                      | 🟡 Medium  | Two Pointers      | 🔲     |
| 13  | Subarray Sum Equals K                     | 🟡 Medium  | Prefix Sum + Map  | 🔲     |
| 14  | Minimum Window Substring                  | 🔴 Hard    | Sliding Window    | 🔲     |
...
_Updated after each module. Track commits to see progress over time._
